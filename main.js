...
const songsList = [
  ...
  {
    name: "Atese Dustum",
    link: "mp3/atesedüstüm.mp3",
    artist: "Mert Demir",
    image: "images/mertdemir.jpeg",
  },
  {
    name: "Sen Sevdamısın",
    link: "mp3/senSevdamisin.mp3",
    artist: "Buray",
    image: "images/buray.jpeg",
  },
  {
    name: "Firuze",
    link: "mp3/Firuze.mp3",
...
repeatButton.addEventListener(`click`,() => {
    if (repeatButton.classList.contains
        ('active')){
